# Eder Fernando Torres
Embedded Firmware Engineer | Hardware–Software Integration
...
- **MCUs/Platforms:** MSP430, PIC18, ARM-class MCUs, RP2040, FPGAs
- **Interfaces:** UART, SPI, I2C, PWM, ADC, encoders
- **Controls:** motor trajectory/control pipelines, timing/interrupt-driven design
...
- **Servo Controller (MSP430G2553)**
  - Timer/interrupt-driven PWM, UART control interface
- **Mercury Robotics Challenge Robot**
